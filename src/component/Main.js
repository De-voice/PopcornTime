...
function Main() {
	return (
		<>
			...
			<main>
				<section
					className="my-2 grid grid-cols-1 sm:py-20 sm:grid-cols-2 sm:gap-x-40 mx-auto w-4/5">
					<SubMain
				...
				<section className="bg-middleImage bg-center bg-cover bg-no-repeat w-screen border-t-8 border-dashed border-red-500 h-screen  lg:h-3/5 md:py-24 ">
					<section className="grid sm:grid-cols-2 grid-cols-1 mx-auto  sm:mr-32 sm:w-4/5">
						...
						<div>
							<Video
								className="   w-full  h-72 mt-44 sm:mt-11 "
